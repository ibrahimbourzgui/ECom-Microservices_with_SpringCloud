<h2>This is a Microservices based architecture project that contains 4 services( Inventory Service, Customer Service, Billing Service, Discovery Service, and the Gateway Service)<h2>
